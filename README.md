...
* The model retained is the kinematic model.
...
* In the "Kinematic and Dynamic Vehicle Models for Autonomous Driving Control Design" paper, the authors used discretization values of 100ms and 200ms, the paper advocated for 200ms for their testing as it gave them better results. 
...
The waypoints are transformed to the vehicle's perspective. This is done by subtracting them from x and y and rotating the car reference angle to bring it to 0. This makes the vehicle at the origin (0,0) and the orientation angle to be 0 which simplifies the polynomial fit.
